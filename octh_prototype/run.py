...
def uci_experiment(loc, target_col, hot_encode_cols, tree_depths, alphas, repeat, train_test_ratio=0.8, header=None,
                   max_time_per_run=300, threads=None, save_to_file=True, print_status=False, f_name=None,
            ...
            for r in range(repeat):
                ...
                if print_status:
                    print('Training parameters: alpha={0}, tree depth={1}\nBaseline accuracy: {2}'
                          .format(alpha, tree_depth, stats_baseline_accuracies[-1]))
    ...
    if save_to_file:
        ...
        if not isinstance(f_name, str):
            ...
            file_name = 'OCT-H_' + f_name + '_' + date_string + '.csv'
...
if __name__ == '__main__':
    ...
    # loc= 'http://archive.ics.uci.edu/ml/machine-learning-databases/iris/iris.data'
    ...
    print_status = True
    results = uci_experiment(loc, target_col, hot_encode_cols, tree_depths, alphas, repeat,
                             train_test_ratio=train_test_ratio, f_name=f_name, threads=threads,
                             max_time_per_run=max_time_per_run, print_status=print_status)
